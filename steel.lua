...
if core.get_modpath("lucky_block") then
	lucky_block:add_blocks({
		{"dro", {"mystreets:galvanized_steel"}, 12},
		{"dro", {"mystreets:block_galvanized_steel"}, 2},
		{"dro", {"mystreets:ingot_galvanized_steel"}, 12},
		{"dro", {"mystreets:fence_galvanized_steel"}, 12},
		{"dro", {"mystreets:truss"}, 12},
	})
end
